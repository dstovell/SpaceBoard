...
public class SpaceBoardTestLevel : MonoBehaviour
{
	...
	void Start ()
	{
		...
		SpaceBoardComponent.Instance.CreateEntity(player1.Team, player1.Id, "Frigate_Predator_Blue", 1, 0);

		uint player2Id = 1002;
		TacticalBoard.Player player2 = SpaceBoardComponent.Instance.CreatePlayer(player2Id, TacticalBoard.PlayerTeam.TeamB);
		SpaceBoardComponent.Instance.CreateEntity(player2.Team, player2.Id, "Frigate_Predator_Black", 2, 5);
	}
}
